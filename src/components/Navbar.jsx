  ...
  return (
    ...
    <div className="container">
      ...
      <div className="d-flex gap-3 align-items-center">
        <button className="butt p-2 px-3  d-xl-flex d-none "><img src="./img/ikonka.png" alt=""/>Каталог</button>
        <input  className="typ" type="text"  placeholder="Найти товар"/>
      </div>
      <div className="d-flex gap-4">
        <div className="text-center flex-column d-xl-flex d-none ">
      ...
      <div className="d-flex gap-3 align-items-center text-center d-xl-flex d-none">
